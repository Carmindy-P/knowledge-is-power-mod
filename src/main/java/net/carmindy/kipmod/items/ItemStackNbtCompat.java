...
public final class ItemStackNbtCompat {
    ...
    private static final String[] HAS_NAMES = {"hasNbt", "hasTag", "hasCompoundTag"};
    ...
    public static Object getOrCreateNbt(ItemStack stack) {
        initMethods();
        try {
            if (itemstack_getOrCreate != null) return itemstack_getOrCreate.invoke(stack);
            Object existing = itemstack_get != null ? itemstack_get.invoke(stack) : null;
            if (existing != null) return existing;
            Object newNbt = createNbtInstance();
            if (newNbt != null && itemstack_set != null) itemstack_set.invoke(stack, newNbt);
            return newNbt;
    ...
    public static Object getNbt(ItemStack stack) {
        initMethods();
        try {
            return itemstack_get != null ? itemstack_get.invoke(stack) : null;
        } catch (IllegalAccessException | InvocationTargetException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static void putString(Object nbt, String key, String value) {
        ...
        try { nbt_putString.invoke(nbt, key, value); } catch (Exception e) { throw new RuntimeException(e); }
    }

    public static String getString(Object nbt, String key) {
        initMethods();
        if (nbt == null || nbt_getString == null) return null;
        try { Object res = nbt_getString.invoke(nbt, key); return res != null ? res.toString() : null; }
    ...
    public static boolean contains(Object nbt, String key) {
        ...
        try { Object res = nbt_contains.invoke(nbt, key); return res instanceof Boolean && (Boolean) res; }
        catch (Exception e) { throw new RuntimeException(e); }
    }
    ...
    private static Object createNbtInstance() {
        ...
        try { Constructor<?> ctor = nbtClass.getDeclaredConstructor(); ctor.setAccessible(true); return ctor.newInstance(); }
        catch (Exception e) { throw new RuntimeException(e); }
    }
}
